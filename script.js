...
// Timeline
var events=[
  {date:"أول يوم",emoji:"📸",title:"لما اتقابلنا أول مرة 💕",desc:"اليوم اللي غيّر كل حاجة... لحظة مش هنساها أبدًا 🥺"},
  {date:"أول خروجة",emoji:"🎭",title:"أول مرة نخرج مع بعض 🎭",desc:"ضحكنا لحد ما عيّطنا 😂💗 يوم هنفتكره طول العمر"},
  {date:"لحظة مميزة",emoji:"🌅",title:"أجمل غروب شمس 🌅",desc:"الوقت وقف لحظة... كانت سحرية 💗"},
  {date:"عيد ميلادك",emoji:"🎂",title:"يوم عيد ميلادك 🎂",desc:"فاكر/ة التورتة؟ 😂 أحلى يوم في السنة"},
  {date:"قهوتنا",emoji:"☕",title:"قهوتنا المفضلة ☕",desc:"كل رشفة كانت أحلى وانتي جنبي 🥰"},
  {date:"ليلة مميزة",emoji:"🌙",title:"ليلة سحرية 🌙",desc:"واحدة من أجمل الليالي في حياتي... ما بتخلصش ✨"}
];
